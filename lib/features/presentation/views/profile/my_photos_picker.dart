...
class MyPhotosPickerView extends BaseView {
  @override
  State<MyPhotosPickerView> createState() => _MyPhotosViewState();
}

class _MyPhotosViewState extends BaseViewState<MyPhotosPickerView> {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ReorderableGridView.count(
                        ...
                        .where((element) => element.networkImage!=null && element.networkImage!.isNotEmpty).toList()
                            .map(
                              (entity) => Container(
                            key: ValueKey(entity),
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pop(context, entity.orderId);
                              },
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(10),
                                child: Stack(
